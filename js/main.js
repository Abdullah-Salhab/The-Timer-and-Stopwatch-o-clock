        ...
        var time=0
        // this is when time is zero not to play audio
        var isMoreThanZero = false;
        // this function for start the stopwatch and change the timer_box
        function uptimer() {
            play("audio1");
            stop("audio2");
            document.getElementById("start2").style.opacity=0;
            document.getElementById("start2").style.cursor="not-allowed";
            time++
            //this for milisecond
            if (time%99<10) {
        ...
        function split_time() {
            ...
            let table = document.getElementById("split");
            let p = document.createElement("p");
            p.append(h+":"+mi+":"+se+":"+misec);
            table.prepend(p);
        }
        ...
        function restart() {
            ...
            document.getElementById("stop").style.opacity=0.5;
            document.getElementById("stop").style.cursor="not-allowed";
            document.getElementById("start2").style.cursor="pointer";
